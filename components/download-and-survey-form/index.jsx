...
const DownloadAndSurveyForm = () => {
    return (
        <div>
            <div className="max-w-[640px] mx-auto w-full flex items-center my-16 justify-center p-4">
                <form className="bg-[#003366] text-white rounded-2xl p-8 py-10 w-full max-w-2xl space-y-4 shadow-xl">
                    <h2 className='text-center font-bold text-xl !mb-5 sm:text-2xl md:text-4xl'>Get the Book Free Here!</h2>
...
export default DownloadAndSurveyForm